module baud_controller(input clk, input reset, input enable, input [2:0] baud_select, output wire enable_sample);
    ...
    parameter max_4 = 15'd325; //sfalma .5208333...
    parameter max_5 = 15'd162; //sfalma .76041666...
    parameter max_6 = 15'd108; //sfalma .5069444...
    parameter max_7 = 15'd54; //sfalma .25347222...
